 ...
 * 手动模式相关数据.
 */
public class ShellManualActionData extends BaseActionData {
     ...
     * 时间
     */
    public static final int TIMER_CODE = 23;

    /**
     * 区域定点
     */
    public static final int POSITION_CODE = 42;

    /**
     * 零重力调节
     */
    public static final int ZERO_GRAVITY_CODE = 20;

    /**
     * 速度调节
     */
    public static final int SPEED_MINUS_CODE = 24;
    public static final int SPEED_ADD_CODE = 25;

    /**
     * 气压调节
     */
    public static final int AIR_MINUS_CODE = 26;
    public static final int AIR_ADD_CODE = 27;

    /**
     * 单项数据.
     */
    private final static int[] INDIVIDUAL_CODES = {28, 29, 30, 31};
    private final static String[] INDIVIDUAL_NAMES = {"脚滚", "热敷", "腿肚", "振动"};

    /**
     * 手法.
     * "揉敲"等于"揉捏"+ "敲打".
     */
    private final static int[] TECHNIQUE_MODE_CODES = {32, 33, 34, 35, 36};
    private final static String[] TECHNIQUE_MODE_NAMES = {"揉捏", "敲打", "揉敲", "指压", "推拿"};

    /**
     * 宽度.
     */
    private final static int[] WIDTH_CODES = {37, 38, 39};
     ...
     * 气压部位.
     */
    private final static int[] STRENGTH_PRESSURE_CODES = {43, 44, 45, 46};
     ...
     * 长按单项数据.
     */
    private final static int[] LONG_CLICK_INDIVIDUAL_CLICK_CODES = {16, 17, 21, 22, 18, 19};
