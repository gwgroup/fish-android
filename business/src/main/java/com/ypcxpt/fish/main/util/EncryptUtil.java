...
public class EncryptUtil {
	...
	public static String getEncryptValue(String jsonStr) {
		...
		Logger.i("EncryptUtil", "Value加密结果:" + Base64.encodeToString(jsonStr.getBytes(), Base64.DEFAULT));
	...
	public static String getEncryptSign(String jsonStr) {
		...
		Logger.i("EncryptUtil", "Sign加密结果:" + MD5(Base64.encodeToString(jsonStr.getBytes(), Base64.DEFAULT) + signString));
