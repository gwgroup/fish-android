...
public class AppFileDownUtils extends Thread {
    ...
    public static final String DOWNlOAD_FILE = "/apks";
...
//                String dlpath = sdcardDir.getPath() + DOWNlOAD_FILE;
                String dlpath = sdcardDir.getAbsolutePath() + DOWNlOAD_FILE;
                Logger.e("AppFileDownUtils", dlpath);
...
//                final File saveFilePath = new File(folder, mFileName);
                final File saveFilePath = new File(folder.getAbsolutePath() + "/" +  mFileName);
...
//                download(mDownloadUrl, saveFilePath);
            }
        } catch (Exception e) {
            onFail(e.getMessage());
        }
