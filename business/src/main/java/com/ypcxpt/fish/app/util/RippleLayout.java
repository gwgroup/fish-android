...
public class RippleLayout extends RelativeLayout {
    ...
    private static final int DEFAULT_DURATION_TIME = 2500; //一轮的时间
    private static final float DEFAULT_SCALE = 6.0f; //放大倍数
    private static final int DEFAULT_RIPPLE_COLOR = R.color.white; //里圈颜色
    private static final int DEFAULT_STROKE_WIDTH = 0;
    private static final int DEFAULT_RADIUS = 65; //里圈半径px
