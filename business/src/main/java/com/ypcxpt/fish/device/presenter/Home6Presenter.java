...
import com.ypcxpt.fish.core.ble.input.Home6DataParser;
...
import com.ypcxpt.fish.device.contract.Home6Contract;
...
public class Home6Presenter extends BaseBLEPresenter<Home6Contract.View> implements Home6Contract.Presenter {
    /* 是否开机 */
    ...
    public void onNotificationReceived(String content) {
        ...
        Home6DataParser parser = Home6DataParser.get();
    ...
    /* 自动程序 */
    private void readAutoMode(Home6DataParser parser, List<Integer> data) {
    ...
    /* 机器状态 */
    private void readDeviceState(Home6DataParser parser, List<Integer> data) {
