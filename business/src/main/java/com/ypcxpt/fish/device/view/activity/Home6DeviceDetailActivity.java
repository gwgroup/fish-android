...
import com.ypcxpt.fish.device.presenter.Home6Presenter;
...
@Route(path = Path.Device.HOME6)
public class Home6DeviceDetailActivity extends BaseActivity implements Home6Contract.View {
...
//    @BindView(R.id.tv_zidong) TextView tv_zidong;
    ...
    private Home6Contract.Presenter mPresenter;
    ...
    protected int layoutResID() {
        return R.layout.activity_device_detail_home6;
    }
    ...
    protected void initData() {
        ...
        Logger.i("Home6DeviceDetailActivity", "macAddress:" + macAddress + ",characteristicUuid:" + UUID.fromString(characteristicUuid));
    }

    @Override
    protected void initViews() {
        tv_title.setText("HOME-6S");
        initSupl();
        initPopup();
        initState();
        initLongClickFunc();
